...
#define MEM_FIQ_STACK		(MEM_KERNEL_END + FIQ_STACK_SIZE)		// expands down
#define MEM_KERNEL_STACK	(MEM_FIQ_STACK + KERNEL_STACK_SIZE)		// expands down
#if RASPPI == 1
